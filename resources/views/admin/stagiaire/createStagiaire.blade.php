<x-app-layout>
    ...
    <div class="container mx-auto py-10 px-2 md:px-0">
        ...
        @if (session()-> has('error'))
                <div class="my-2 flex p-4 mb-4  text-lg text-green-800 border border-green-300 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 dark:border-green-800" role="alert">
