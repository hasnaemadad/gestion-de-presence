...
<x-app-layout>
    ...
    <div class="container mx-auto py-10 px-2 md:px-0">
        ...
        <div class="mt-6">
            ...
            <div class="relative">
                ...
                <input type="search" id="searchInput"
                    ...
                    placeholder="Search Sagiaire , Nom..." required>
                <button disabled
        ...
        <div class="overflow-x-auto">
            <table
                class="my-2 min-w-full table-auto divide-y divide-gray-200 px-2 py-1 dark:text-gray-100 md:px-6 md:py-3">
                <thead>
                    <tr>
                        <th scope="col"
                            ...
                            <td
                                ...
                                <div class="flex space-y-2 md:flex-row md:space-y-0 md:space-x-4">
                                    <a class="mt-2 text-lg md:mt-0"
                                        href="{{ route('admin.showStagiaire', $stagiaire->id) }}">
...
<script>
    ...
    input.onkeydown = function() {
        ...
        for (var i = 0; i < data.length; i++) {
            if (data[i].nom.toLowerCase().includes(input.value.toLowerCase()) || data[i].prenom.toLowerCase()
                ...
                <tr>
                    ...
                    <a class="text-lg" href="/admin/stagiaire/${idStg}/edit">
                        ...
                        <form action="/admin/stagiaire/${idStg}" method="POST">
                            @csrf
                            @method('DELETE')
